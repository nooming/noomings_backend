...
from citywalk.core.planning.plan_service import execute_plan_request, fetch_poi_photos
...
from citywalk.core.agent.intent import (
...
def agent_plan_once():
    ...
    try:
        ...
        from citywalk.core.agent.session_store import create_session, update_session
        from citywalk.core.agent.chat_handler import build_route_summary
...
def _agent_rate_check():
    from citywalk.core.agent.rate_limit import allow_request
...
def agent_chat():
    ...
    try:
        ...
        from citywalk.core.agent.chat_handler import handle_chat
...
def agent_guide():
    ...
    payload = request.get_json(silent=True) or {}
    from citywalk.core.agent.guide import generate_guide
...
def poi_enrich():
    ...
    try:
        ...
        from citywalk.core.agent.enrichment import describe_poi
