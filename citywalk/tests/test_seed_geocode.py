...
from citywalk.core.geo.geocoding import place_text_search, resolve_seed_location
from citywalk.core.planning.plan_service import build_seed_pois
...
class TestSeedGeocode(unittest.TestCase):
    ...
    @patch("citywalk.core.geo.geocoding.get_city_from_location")
    @patch("citywalk.core.geo.geocoding.place_text_search")
    ...
    @patch("citywalk.core.geo.geocoding._coords_match_target_city", return_value=True)
    @patch("citywalk.core.geo.geocoding.place_text_search")
    ...
    @patch("citywalk.core.geo.geocoding.api_request_with_retry")
    ...
    @patch("citywalk.core.planning.plan_service.resolve_seed_location")
